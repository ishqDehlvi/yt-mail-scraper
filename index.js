...
(async () => {
  let channel = ["TechBurner", "StringReveals", "Mrwhosetheboss"];
  for(var i=0; i<channel.length; i++){
    let url = "https://www.youtube.com/c/"+channel[i]+"/about";
  // // let joinChannel = ["mkbhd"];
  // let url = "https://www.youtube.com/c/StringReveals/about";
    let login =
  ...
  //identifierId
  await page.type("#identifierId", "EMAIL ID");
  ...
  //     let url = "https://www.youtube.com/c/"+channel[i]+"/about";
      ...
      await page.evaluate(() => {
        ...
        element.classList.add("shubhamRam");
      });
      sleep(5000);
      await page.click(".shubhamRam");
      await page.waitForSelector(".shubhamRam");
      sleep(4000);
